...
public class SevenAndThirtyTopAdapter extends CommonAdapter {
    private static final String TAG = "SevenAndThirtyTopAdapter";
    ...
    protected void convert(ViewHolder viewHolder, Object item, int position) {
        ...
        if (position < 3) {
            tvRight.setText(listRight.get(position) + "次");
        } else {
            tvRight.setText(listRight.get(position) + "");
        }
        ...
        int marginWidth = ConvertUtils.dp2px(2 * 10 + 2 * 10);
        ...
        switch (position) {
            case 0:
                if (totalCount > 0) {
                    ...
                    gradientDrawable = DrawableUtils.getGradientDrawable(ColorUtils.getColor(R.color.main_red), ColorUtils.getColor(R.color.main_red));
            ...
            case 1:
                if (totalCount > 0) {
                    ...
                    tvCenter.setLayoutParams(layoutParams);
                    gradientDrawable = DrawableUtils.getGradientDrawable(ColorUtils.getColor(R.color.sugar_green_bright), ColorUtils.getColor(R.color.sugar_green_bright));
                    tvCenter.setBackground(gradientDrawable);
                }
                break;
            case 2:
                if (totalCount > 0) {
                    ...
                    tvCenter.setLayoutParams(layoutParams);
                    gradientDrawable = DrawableUtils.getGradientDrawable(ColorUtils.getColor(R.color.home_blue), ColorUtils.getColor(R.color.home_blue));
                    tvCenter.setBackground(gradientDrawable);
                }
                break;
            case 3:
                ...
                gradientDrawable = DrawableUtils.getGradientDrawable(ColorUtils.getColor(R.color.sugar_purple), ColorUtils.getColor(R.color.sugar_purple));
                tvCenter.setBackground(gradientDrawable);
                break;
            case 4:
                ...
                gradientDrawable = DrawableUtils.getGradientDrawable(ColorUtils.getColor(R.color.sugar_green_light), ColorUtils.getColor(R.color.sugar_green_light));
                tvCenter.setBackground(gradientDrawable);
                break;
            case 5:
                ...
                gradientDrawable = DrawableUtils.getGradientDrawable(ColorUtils.getColor(R.color.sugar_blue_bright), ColorUtils.getColor(R.color.sugar_blue_bright));
                tvCenter.setBackground(gradientDrawable);
                break;
        }
