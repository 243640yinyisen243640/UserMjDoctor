...
public class SugarReportBean {
    ...
    public void setWuchzhi(List<List<Integer>> wuchzhi) {
    ...
    public void setWancqzhi(List<List<Integer>> wancqzhi) {
    ...
    public void setWanchzhi(List<List<Integer>> wanchzhi) {
    ...
    public void setShuiqzhi(List<List<Integer>> shuiqzhi) {
    ...
    public void setSuijizhi(List<List<Integer>> suijizhi) {
    ...
    public void setKongfuzhi(List<List<Integer>> kongfuzhi) {
    ...
    public void setZch2zhi(List<List<Integer>> zch2zhi) {
    ...
    public void setWucqzhi(List<List<Integer>> wucqzhi) {
