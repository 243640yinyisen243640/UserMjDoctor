 ...
 */
@BindEventBus
public class PatientHealthArchiveFragment extends BaseEventBusFragment implements AdapterViewClickListener, View.OnClickListener {
    ...
    private void toDoSave(String fieldName, String fieldValue) {
        ...
        map.put("uid", getArguments().getString("userid"));
