...
public class HepatopathyPabulumDetailActivity extends BaseHideLineActivity {
    ...
    private void getDetail() {
        ...
        map.put("id", id);
        RxHttp.postForm(XyUrl.HEPATOPATHY_PABULUM_DETAIL)
                .addAll(map)
                .asResponse(HepatopathyPabulumDetailBean.class)
                .to(RxLife.toMain(this))
                .subscribe(new Consumer<HepatopathyPabulumDetailBean>() {
                    @Override
                    public void accept(HepatopathyPabulumDetailBean updateBean) throws Exception {
                        HepatopathyPabulumDetailBean data = updateBean;
                        setDetail(data);
                    }
                }, new OnError() {
                    @Override
    ...
    private void setTvChecked(ColorTextView tv) {
        ...
        tv.getColorHelper().setBackgroundColorNormal(ColorUtils.getColor(R.color.main_red));
        tv.getColorHelper().setBorderColorNormal(ColorUtils.getColor(R.color.main_red));
    }
