...
//
//public class HomeSignFamilyAdapter extends CommonAdapter<HomeSignFamilyBean> {
//
...
//
//    public HomeSignFamilyAdapter(Context context, int layoutId, List<HomeSignFamilyBean> datas, boolean isExtra) {
...
//
//    @Override
//    protected void convert(ViewHolder holder, HomeSignFamilyBean homeSignBean, int position) {
